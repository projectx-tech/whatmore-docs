...
integration and uses the [Core APIs](authentication.md) plus the dashboard.
...
(see [Catalog API → Connect in the dashboard](catalog-api.md#connect-in-the-dashboard-recommended)):
...
[Catalog API](catalog-api.md#catalog-api-automation) instead.)*
...
into your site where you want the surface. For mobile apps, use the [App SDK](app-sdk.md)
