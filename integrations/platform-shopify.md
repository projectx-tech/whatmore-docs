...
- **Catalog** — your Shopify products sync automatically; no [Catalog API](/integrations/catalog-api)
  calls needed.
...
The [Core APIs](/integrations/authentication) and [App SDK](/integrations/app-sdk) in this section are for
